  ...
  try {
    ...
    await prisma.activityLog.create({
      data: {
        ...
        details: `Finalized ${results.finalized} auctions for week of ${weekStartDate.toLocaleDateString()}. Auctions finalized by ${user.nickname} on ${new Date().toLocaleDateString()}`
      }
    });
